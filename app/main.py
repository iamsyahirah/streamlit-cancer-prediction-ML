...
def main():
    ...
    with st.container():
        ...
        st.write("This web app predicts whether a breast mass is benign or malignant using a machine learning model based on received measurements. Additionally, you can manually adjust the measurements using sliders in the sidebar.")
        st.write("This web app can assist medical professionals in making a diagnosis but should not be used as a substitute for a professional diagnosis.")
